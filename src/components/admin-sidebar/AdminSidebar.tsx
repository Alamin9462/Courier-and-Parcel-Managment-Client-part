    ...
    <div className="h-full w-full shadow-md flex flex-col justify-between bg-base-200">
      <div className="p-5">
        ...
        <nav className="space-y-2 my-8 font-light">
          <NavLink to="/admin" onClick={onLinkClick} end className={linkClass}>
            <Gauge className="w-5 h-5" />
            Dashboard
          </NavLink>

          <NavLink to="/admin/all-parcels" onClick={onLinkClick} className={linkClass}>
            <Box className="w-5 h-5" />
            Parcels
          </NavLink>

          <NavLink to="/admin/agents" onClick={onLinkClick} className={linkClass}>
            <UserCog className="w-5 h-5" />
            Agents
          </NavLink>

          <NavLink to="/admin/customers" onClick={onLinkClick} className={linkClass}>
            <Users className="w-5 h-5" />
            Customers
          </NavLink>

          <NavLink to="/admin/reports" onClick={onLinkClick} className={linkClass}>
